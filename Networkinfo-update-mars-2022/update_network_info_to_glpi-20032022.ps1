...
$NetworkInfoupdate.text          = "NetworkInfoupdate"
...
$Label3.text                     = "Update Completed Successfully :"
...
foreach ($comp in $ComputerName){
    ...
    $res =  Invoke-DiscoveryProtocolCapture -ComputerName $comp -Force| Get-DiscoveryProtocolData
    ...
    try
        {
            $networkoutlet = $res.PortDescription
