...
Write-Host $output
$output | ForEach-Object -Parallel {Invoke-DiscoveryProtocolCapture -ComputerName $_ | Get-DiscoveryProtocolData} |Select-Object @{Name = "Hostname";  Expression = {extractstring $_.Computer}},@{Name = "Switch";  Expression = {extractstring $_.Device}},Port,PortDescription | Out-GridView
